...
function PcArmada() {
  ...
  async function getData() {
    await axios
      .get(`/warehouse?category=Memory`)
      .then((res) =>
        setMemory(
          res.data
            .filter((p) => currentLow.mem === p.Product.id)
            .sort((b, a) => b.precio - a.precio)[0]
        )
      );
    ...
    await axios
      ...
      .then((res) =>
        setDisk(
          res.data
            .filter((p) => currentLow.dis === p.Product.id)
            .sort((b, a) => b.precio - a.precio)[0]
        )
      );
    ...
    await axios
      ...
      .then((res) =>
        setVideocard(
          res.data
            .filter((p) => currentLow.vid === p.Product.id)
            .sort((b, a) => b.precio - a.precio)[0]
        )
      );
    ...
    await axios
      ...
      .then((res) =>
        setMother(
          res.data
            .filter((p) => currentLow.mot === p.Product.id)
            .sort((b, a) => b.precio - a.precio)[0]
        )
      );
    ...
    await axios
      ...
      .then((res) =>
        setPower(
          res.data
            .filter((p) => currentLow.pow === p.Product.id)
            .sort((b, a) => b.precio - a.precio)[0]
        )
      );

    await axios
      .get(`/warehouse?category=Case`)
      .then((res) =>
        setGabinete(
          res.data
            .filter((p) => currentLow.gab === p.Product.id)
            .sort((b, a) => b.precio - a.precio)[0]
        )
      );

    await axios
      .get(`/warehouse?category=CPU`)
      .then((res) =>
        setCpu(
          res.data
            .filter((p) => currentLow.cpu === p.Product.id)
            .sort((b, a) => b.precio - a.precio)[0]
        )
      );
    ...
    await axios
      ...
      .then((res) =>
        setMouse(
          res.data
            .filter((p) => currentLow.mou === p.Product.id)
            .sort((b, a) => b.precio - a.precio)[0]
        )
      );
    ...
    await axios
      ...
      .then((res) =>
        setKeyboard(
          res.data
            .filter((p) => currentLow.key === p.Product.id)
            .sort((b, a) => b.precio - a.precio)[0]
        )
      );

    await axios
      .get(`/warehouse?category=Monitor`)
      .then((res) =>
        setMonitor(
          res.data
            .filter((p) => currentLow.mon === p.Product.id)
            .sort((b, a) => b.precio - a.precio)[0]
        )
      );
  }
  ...
  async function getDataTop() {
    await axios
      ...
      .then((res) =>
        setMemoryTop(
          res.data
            .filter((p) => currentTop.mem === p.Product.id)
            .sort((b, a) => b.precio - a.precio)[0]
        )
      );
    ...
    await axios
      ...
      .then((res) =>
        setDiskTop(
          res.data
            .filter((p) => currentTop.dis === p.Product.id)
            .sort((b, a) => b.precio - a.precio)[0]
        )
      );
    ...
    await axios
      ...
      .then((res) =>
        setVideocardTop(
          res.data
            .filter((p) => currentTop.vid === p.Product.id)
            .sort((b, a) => b.precio - a.precio)[0]
        )
      );
    ...
    await axios
      ...
      .then((res) =>
        setMotherTop(
          res.data
            .filter((p) => currentTop.mot === p.Product.id)
            .sort((b, a) => b.precio - a.precio)[0]
        )
      );
    ...
    await axios
      ...
      .then((res) =>
        setPowerTop(
          res.data
            .filter((p) => currentTop.pow === p.Product.id)
            .sort((b, a) => b.precio - a.precio)[0]
        )
      );
    ...
    await axios
      ...
      .then((res) =>
        setGabineteTop(
          res.data
            .filter((p) => currentTop.gab === p.Product.id)
            .sort((b, a) => b.precio - a.precio)[0]
        )
      );
    ...
    await axios
      ...
      .then((res) =>
        setCpuTop(
          res.data
            .filter((p) => currentTop.cpu === p.Product.id)
            .sort((b, a) => b.precio - a.precio)[0]
        )
      );
    ...
    await axios
      ...
      .then((res) =>
        setMouseTop(
          res.data
            .filter((p) => currentTop.mou === p.Product.id)
            .sort((b, a) => b.precio - a.precio)[0]
        )
      );
    ...
    await axios
      ...
      .then((res) =>
        setKeyboardTop(
          res.data
            .filter((p) => currentTop.key === p.Product.id)
            .sort((b, a) => b.precio - a.precio)[0]
        )
      );
    ...
    await axios
      ...
      .then((res) =>
        setMonitorTop(
          res.data
            .filter((p) => currentTop.mon === p.Product.id)
            .sort((b, a) => b.precio - a.precio)[0]
        )
      );
  }
  ...
  if (gama !== "Home") {
    ...
    arrayLow.push(memory, disk, mother, cpu, gabinete, power);
  }
  ...
  if (gama !== "Home") {
    ...
    arrayTop.push(memoryTop, diskTop, motherTop, cpuTop, gabineteTop, powerTop);
  }
  ...
  return (
    <div className="flex flex-col sm:flex-row justify-around items-center bg-gray-400">
      {/* <section>
        <img
      ...
      <section  className="flex flex-col gap-5 my-5 border-2 p-10 rounded-md bg-white shadow-lg shadow-black">
        <h1 className="text-center text-2xl"> {gama} - Basica</h1>
        <div className="h-[300px] overflow-y-scroll p-5 border-2">
        {memory.precio && (
          <div className="flex m-5 shadow-black   rounded-md flex-col justify-center border-2 items-center w-[200px] h-[250px]">
        ...
        {gabinete.precio && (
          <div className="flex m-5 shadow-black   rounded-md flex-col justify-center border-2 items-center w-[200px] h-[250px]">
            ...
            <br />
            <p className="font-bold text-center">
              {gabinete.Seller.store_name}
            </p>
          </div>
        )}
        </div>
        <h3 className="text-center  text-2xl">Total : {sumaLow}</h3>
        <button
      ...
      <section className="flex flex-col gap-5 my-5 border-2 p-10 rounded-md bg-white shadow-lg shadow-black">
        <h1 className="text-center text-2xl"> {gama} - Top</h1>
        <div className="h-[300px] overflow-y-scroll p-5 border-2">
        {memoryTop.precio && (
          <div className="flex m-5 shadow-black   rounded-md flex-col justify-center border-2 items-center w-[200px] h-[250px]">
            ...
            <br />
            <p className="font-bold text-center">
              {memoryTop.Seller.store_name}
            </p>
          </div>
        )}
        {gama !== "Home" && videocardTop.precio && (
          <div className="flex m-5 shadow-black   rounded-md flex-col justify-center border-2 items-center w-[200px] h-[250px]">
            ...
            <br />
            <p className="font-bold text-center">
              {videocardTop.Seller.store_name}
            </p>
          </div>
        )}
        ...
        {gabineteTop.precio && (
          <div className="flex m-5 shadow-black rounded-md flex-col justify-center border-2 items-center w-[200px] h-[250px]">
            ...
            <br />
            <p className="font-bold text-center">
              {gabineteTop.Seller.store_name}
            </p>
          </div>
        )}
        </div>
        <h3 className="text-center text-2xl">Total : {sumaTop}</h3>
        <button
          className="px-4 py-2 hover:bg-gray-400 duration-300 hover:text-white bg-gray-300 rounded-md"
